...
def Formula_4(self, changes):
    ...
    if self.S and self.p and self.a and self.c and not self.b:
        ...
        self.loigiai.append([22, f'Tính cạnh b:\nsqrt((2*{self.S}/({self.p}-{self.a}-{self.c}))={round(self.b)}'])
    ...
    if self.S and self.p and self.a and self.b and not self.c:
        ...
        self.loigiai.append([23, f'Tính cạnh a:\nsqrt((2*{self.S}/({self.p}-{self.a}-{self.b}))={round(self.c)}'])
...
def Formula_5(self, changes):
    if self.S and self.c and not self.hc:
        ...
        self.loigiai.append([24, f'Tính chiều cao hc:\n(2*{self.S}/{self.c}) = {round(self.hc)}'])
        self.Gia_tri_tinh.append([24, "hc"])
        changes = True

    if self.hc and self.c and not self.S:
        self.S = (self.hc * self.c) / 2
        self.loigiai.append([25, f'Tính chiều cao hc:\n({self.hc}*{self.c})/2 = {round(self.S)}'])
        self.Gia_tri_tinh.append([25, "S"])
        changes = True

    if self.S and self.hc and not self.c:
        self.c = (2 * self.S) / self.hc
        self.loigiai.append([26, f'Tính chiều cao hc:\n(2*{self.S}/{self.hc}) = {round(self.c)}'])
...
def Formula_6(self, changes):
    if self.S and self.a and self.b and self.c and not self.R:
        ...
        self.loigiai.append([27,f'Tính bán kính đường tròn ngoại tiếp R:\n({self.a}*{self.b}*{self.c})/(4*{self.S}) = {self.R}'])
    ...
    if self.R and self.a and self.b and self.c and not self.S:
        ...
        self.loigiai.append([28,f'Tính diện tích tam giác S:\n({self.a}*{self.b}*{self.c})/(4*{self.R})'])
